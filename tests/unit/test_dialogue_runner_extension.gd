...
func _test_entry_override_valid() -> void:
	...
	var ok = dr.start("res://tests/fixtures/store_clerk_test.json", "test_clerk", "clerk_greet_cynical")
...
func _test_entry_override_empty_uses_default() -> void:
	var dr = load("res://gdscripts/dialogue_runner.gd").new()
	var ok = dr.start("res://tests/fixtures/store_clerk_test.json", "test_clerk", "")
