...
| Shandong Wolf — AtmosphereController 氛围编排 | `shandong-wolf/gdscripts/atmosphere_controller.gd`（Node2D 氛围统一入口：唯一 Moonlight 赋值 + 水墨/雪幕/血色 tunables + 层契约注释；载体 impl/582 分支） | ✅ | GDD |
