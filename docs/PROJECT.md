...
| 最近构建 | 2026-08-21（shandong-wolf 敌人出生点外移 #716：EnemySpawnA 700→1000，间距 360px > HITBOX_RANGE=80 消除空气命中；此前 敌人 AI 运行时驱动链 #710 / 腿 Line2D 方向修正 #709 / 敌人 Boss 血条 UI #701 / 火柴人结构完整化 #694 / 精英 Boss AI #695 / E2E 截图链路修复 #678） |
| 开放 Issues | 1 |
...
| Shandong Wolf — CombatEntity | `shandong-wolf/gdscripts/combat_entity.gd`（Node2D 战斗数据容器：两段血/架势/facing + request_transition 唯一转移入口 + 6 信号 + _StateInputBridge 输入桥 + 蓄力重斩瞬时 override ×2（current_windup_frames/current_hp_damage）+ 敌人架势脱战恢复（#682）） | ✅ | GDD |
