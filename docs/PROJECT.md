...
| Shandong Wolf — Hud 极简 HUD | `shandong-wolf/gdscripts/hud.gd`（CanvasLayer layer=1：两段式血条/玩家与敌人架势条/击杀与处决提示/EnemyHealthBar 敌人血条（#682 顶部中央暗红条，与 EnemyStanceBar 双条组合，_HudBar.set_fill_color 覆写），纯信号驱动零轮询 + 内部类 _HudBar _draw 自绘 + low_health_changed 边沿信号） | ✅ | GDD |
