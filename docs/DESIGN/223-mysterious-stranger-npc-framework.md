...
|------|------|--------|-----------|
| `dialogues/underpass_stranger_echo.dialogue` | **Modified** | Expand from ~60 to ~176 lines (already done in live file). Add hallucination-level variant routing for ending path selection. | +20 |
| `dialogues/lobby_stranger.dialogue` | **Modified** | Add hallucination-aware variants to existing nodes (3 variants per dialogue path). | +30 |
