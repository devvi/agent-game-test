...
| [07-STICK-FIGURE-ANIMATION](07-STICK-FIGURE-ANIMATION.md) | 火柴人剪影骨架与关键帧动画 — Line2D 程序化骨架 10 pivot（颈/膝 #683）+ 11 态→clip 镜像映射 + consume_state 契约 + 过渡 ≤2 帧 + additive 刀光 + 24 帧步态循环 + REST_POSE 衔接规约 + set_move_speed 步频同步 + facing 翻转接线 + E2E 截图像具 + 查询委托 API（#574/#612/#681/#692/#683/#694） |
